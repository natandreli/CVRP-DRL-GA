MODELS = {
    "junior": {
        ...
        "training_specs": {
            ...
            "learning_strategy": "Fast learning rate (1e-3 actor, 5e-4 critic) with moderate exploration decay (0.9995)",
            "validation_method": "Greedy evaluation on graduated benchmark set (15-50 nodes) every 100 episodes",
        },
    },
    "mid": {
        ...
        "training_specs": {
            ...
            "learning_strategy": "Moderate learning rate (4e-4 actor, 2e-4 critic) with slower exploration decay (0.9997)",
            "validation_method": "Greedy evaluation on graduated benchmark set (40-100 nodes) every 100 episodes",
        },
    },
    "expert": {
        ...
        "training_specs": {
            ...
            "learning_strategy": "Conservative learning rate (3e-4 actor, 1e-5 critic) with very slow exploration decay (0.99985) for stability",
            "validation_method": "Greedy evaluation on graduated benchmark set (100-150 nodes) with 1:2 random/clustered ratio every 100 episodes",
        },
    },
}
